 ...
 */
$config['site_title']                 = "VueTemplate";       // Site Title, example.com
$config['admin_email']                = "admin@signlab.es"; // Admin Email, admin@example.com
...
$config['maximum_login_attempts']     = 50;                   // The maximum number of failed login attempts.
