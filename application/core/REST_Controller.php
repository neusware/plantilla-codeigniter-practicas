...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        // $this->response($this->input->request_headers(),self::HTTP_OK);
    ...
    protected function _check_token () {        
        if (!empty($this->_args[$this->config->item('rest_token_name')])
                && $this->token->check_token($this->_args[$this->config->item('rest_token_name')])) {
    ...
    protected function _check_cors()
    {
        ...
        if ($this->config->item('allow_any_cors_domain') === TRUE && (ENVIRONMENT != "testing"))
        {
